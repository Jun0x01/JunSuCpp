...
{
	//CString log = _T("Debug output is being displayed here.");
	//int index = m_wndOutputDebug.AddString(log);
	//index = m_wndOutputDebug.AddString(_T("The output is being displayed in rows of a list view"));
	//index = m_wndOutputDebug.AddString(_T("but you can change the way it is displayed as you wish..."));
}
...
void COutputWnd::Output(CString content) {
    int index = m_wndOutputDebug.AddString(content);
	m_wndOutputDebug.SetCurSel(index);
	Invalidate();
}
/////////////////////////////////////////////////////////////////////////////
// COutputList1
